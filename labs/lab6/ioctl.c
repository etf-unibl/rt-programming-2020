...
static ssize_t device_read (struct file *fp, char __user * buf, size_t len,
			     loff_t * off);

static ssize_t device_write (struct file *fp, const char *buf, size_t len,
			      loff_t * off);

static long device_ioctl (struct file *file, unsigned int num,
			   unsigned long arg);
...
static ssize_t
device_read (struct file *fp, char __user * buf, size_t len, loff_t * off) 
{
...
static ssize_t
device_write (struct file *fp, const char __user * buf, size_t len,
	      loff_t * off) 
{
...
static long
device_ioctl (struct file *file, unsigned int num, unsigned long arg) 
{
