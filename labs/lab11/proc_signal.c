...
void terminate_parray(pid_t* parray,int len){
	//U dokumentaciji pise da se ovo koristi ako postoji handler za signal. Ne koristi se, ali prilikom kompajliranja prijavljuje gresku
	//ako se ne posalje
	union sigval s;
